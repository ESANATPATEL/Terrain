 ...
 */
public class CaptureRequest extends SecureNetRestApiSDK.Api.Requests.SecureNetRequest {
	/**
	 * Amount to Capture the account.
	 */
	private double amount;
	/**
	 * Credit-card-specific data. Required for credit card Captures.
	 */
	private Card card;
	/**
	 * Check-specific data.
